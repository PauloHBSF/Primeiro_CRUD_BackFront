...
from backend.schemas import ProductRead, ProductUpdate, ProductCreate
...
def create_product(product: ProductCreate, db: Session = Depends(get_db)):
    new_product = create_product(db, product=product)
    return new_product
...
def create_product(product_id: int, product:ProductUpdate, db: Session = Depends(get_db)):
